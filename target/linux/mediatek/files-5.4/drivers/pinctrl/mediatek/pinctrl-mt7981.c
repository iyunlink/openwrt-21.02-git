...
/* UART2 NO CTS RTS */
static int mt7981_uart2_0_no_cts_rts_pins[] = { 4, 5, };
static int mt7981_uart2_0_no_cts_rts_funcs[] = { 3, 3, };
...
static const struct group_desc mt7981_groups[] = {
	...
	/*  @GPIO(4,5) WM_JTAG(3) */
        PINCTRL_PIN_GROUP("uart2_0_no_cts_rts", mt7981_uart2_0_no_cts_rts),
    /*  @GPIO(8) GBE_LED0(3) */
...
static const char *mt7981_wa_aice_groups[] = { "wa_aice1", "wa_aice2", "wm_aice1_1",
	"wa_aice3", "wm_aice1_2", };
static const char *mt7981_uart_groups[] = { "wm_uart_0", "uart2_0", "uart2_0_no_cts_rts",
