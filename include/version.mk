...
BUILD_PLATFORM = $(call qstrip,$(CONFIG_TARGET_PROFILE))
BUILD_PLATFORM_FIX = $(shell echo $(BUILD_PLATFORM) | awk -F_ '{print $$NF}' | tr a-z A-Z)
BUILD_DATE = $(shell date "+%Y%m%d-%H%M")
BUILD_MSG = R-$(BUILD_PLATFORM_FIX)-$(BUILD_DATE)

BUILD_DATE_FIX = $(shell date "+%Y%m%d")
MANUFACTURERS_VERSION = $(BUILD_PLATFORM_FIX)-$(BUILD_DATE_FIX)
...
VERSION_SED_SCRIPT:=$(SED) 's,%U,$(call sed_escape,$(VERSION_REPO)),g' \
	...
	-e 's,%B,$(call sed_escape,$(BUILD_MSG)),g' \
	-e 's,%O,$(call sed_escape,$(MANUFACTURERS_VERSION)),g'
